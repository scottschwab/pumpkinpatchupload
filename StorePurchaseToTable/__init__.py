...
def main(req: func.HttpRequest, ordertable: func.Out[func.Document]) -> func.HttpResponse:
    ...
    logger.info("trying to send to filestorage")
    # write to the db, in theory it returns a code, but it is always None
    ordertable.set(func.Document.from_dict(body))
    omap = dict()
    # generate the output 
    omap["id"] = uu
